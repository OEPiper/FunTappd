...
Revision ID: f687db6ee9a6
Revises: 
Create Date: 2023-11-13 17:06:08.633448
...
def upgrade():
    ...
    sa.Column('story', sa.String(length=2000), nullable=True),
    ...
    if environment == "production":
        ...
        op.execute(f"ALTER TABLE toasts SET SCHEMA {SCHEMA};")
